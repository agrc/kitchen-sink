...
let button = tv({
  extend: focusRing,
  base: 'px-5 py-2 text-sm text-center transition rounded-full border border-black/10 dark:border-white/10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] dark:shadow-none cursor-default',
  variants: {
    variant: {
      primary:
        'bg-primary-900 hover:bg-primary-700 pressed:bg-primary-800 text-white',
      secondary:
        'bg-secondary-800 hover:bg-secondary-600 pressed:bg-secondary-700 text-white',
      accent:
