...
const styles = tv({
  ...
  variants: {
    isEntering: {
      true: 'animate-in fade-in placement-left:slide-in-from-right-1 placement-right:slide-in-from-left-1 placement-top:slide-in-from-bottom-1 placement-bottom:slide-in-from-top-1 duration-200 ease-out',
    },
    isExiting: {
