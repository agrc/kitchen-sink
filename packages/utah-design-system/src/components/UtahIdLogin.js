...
exports.UtahIdLogin = void 0;
var auth_1 = require("firebase/auth");
var react_1 = require("react");
var contexts_1 = require("../contexts");
var Banner_1 = require("./Banner");
var Button_1 = require("./Button");
var UtahIdLogin = function (_a) {
    var _b = _a.size, size = _b === void 0 ? 'medium' : _b, _c = _a.errorRenderer, errorRenderer = _c === void 0 ? function (error) {
        return <Banner_1.Banner>{error}</Banner_1.Banner>;
    } : _c;
    var _d = (0, react_1.useState)(null), signInError = _d[0], setSignInError = _d[1];
    var _e = (0, contexts_1.useFirebaseAuth)() || {}, auth = _e.auth, provider = _e.provider;
    var handlePress = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        var error_1, errorWithCode, match, response;
        var _a, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!auth || !provider) {
                        console.warn('You must initialize Firebase Auth with an identity provider before using this component');
                        return [2 /*return*/];
                    }
                    _c.label = 1;
                case 1:
                ...
                case 3:
                    ...
                    if (error_1 && typeof error_1 === 'object' && 'code' in error_1) {
                        errorWithCode = error_1;
                        match = /\{.*\}/.exec(errorWithCode.message);
                        if (match === null || match === void 0 ? void 0 : match.length) {
                            try {
                                ...
                                setSignInError((_a = errorWithCode.message) !== null && _a !== void 0 ? _a : 'Unknown error');
                            }
                        }
                        else {
                            setSignInError((_b = errorWithCode.message) !== null && _b !== void 0 ? _b : 'Unknown error');
                        }
                    }
                    else {
